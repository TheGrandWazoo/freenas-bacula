...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding the heartbeatinterval column
            db.add_column('freenas_baculasdstorage', 'baculasd_st_heartbeatinterval',
                          self.gf('django.db.models.fields.IntegerField')(default=0))

    def backwards(self, orm):
        # Delete the heartbeatinterval column
            db.delete_column('freenas_baculasdstorage', 'baculasd_st_heartbeatinterval')
